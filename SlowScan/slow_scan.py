...
Elec_colors = ['gray','green','gray','green','white','yellow','purple','white','purple','blue','red','red','green','yellow','white','yellow','gray','yellow','blue','blue','green','white','purple']
cal_val = 404
def calibrate_test():
    global cal_val
    cal_val = 10000
...
def stop_test():
    ...
    for i in range(23):
        ...
        Ext_elec_print[i].set(str("Not connected"))
